...
class ThinglishInterfaceVisitor extends BaseVisitor {
    ...
    addExtendDeceleration(identifier, innerCallExpression) {
        ...
        let importPath = "";
        let decorator = (_e = symbol === null || symbol === void 0 ? void 0 : symbol.declarations) === null || _e === void 0 ? void 0 : _e[0];
        if (!decorator) {
...
class ThinglishExportVisitor extends BaseVisitor {
    constructor() {
        super(...arguments);
        this.allowedExtensions = ['.interface', '.class'];
    }
    static get validTSSyntaxKind() {
...
_d = ThinglishClassVisitor;
(() => {
    BaseVisitor.implementations.push(_d);
})();
class ThinglishFileVisitor {
    constructor(program, context, sourceFile, phase) {
    ...
    getAllImportedVariables() {
        ...
        existingImports.forEach(importDeclaration => {
            var _e, _f, _g, _h;
            const elements = ((_f = (_e = importDeclaration.importClause) === null || _e === void 0 ? void 0 : _e.namedBindings) === null || _f === void 0 ? void 0 : _f.elements) || [];
            for (const element of elements) {
                allImportVariables.push(element.name.escapedText);
            }
            //if (debug) console.log(importDeclaration.importClause?.name);
            const defaultImport = (_h = (_g = importDeclaration.importClause) === null || _g === void 0 ? void 0 : _g.name) === null || _h === void 0 ? void 0 : _h.escapedText;
